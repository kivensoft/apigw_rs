...
appcfg::appconfig_define!(app_conf, AppConf,
    ...
    unix_sock        : String => ["",   "unix-sock",        "unix sock file",        "零停机重启的Unix Sock文件名"],
...
impl Default for AppConf {
    fn default() -> Self {
        ...
        Self {
            log_filter: "info,apigw=debug,kv_axum_util=debug".into(),
            log_file,
            no_console: false,
            install: false,
            unix_sock: "/tmp/apigw.sock".into(),
            listen: "127.0.0.1:6400".into(),
            dict_file: "dict.cfg".into(),
            task_threads: "1".into(),
            blocking_threads: "32".into(),
            db_file: format!("{APP_NAME}.redb"),
